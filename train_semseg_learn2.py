...
def main(args):
    ...
    if args.anchor_type == 'learn':
        ...
        optimizer_anchor = torch.optim.Adam(
            [anchors,
            opt_params,
            lr=args.learning_rate,
            betas=(0.9, 0.999),
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        # anchor learns late
        if epoch > args.anchor_learn:
            for param_group_anchor in optimizer_anchor.param_groups:
                param_group_anchor['lr'] = lr
        ...
        with torch.no_grad():
            ...
            if epoch > args.anchor_learn:
                state = {
                    ...
                    'optimizer_anchor_state_dict': optimizer_anchor.state_dict(),
                    'best_iou': mIoU
                }
            else:
                state = {
